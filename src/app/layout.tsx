...
export const metadata: Metadata = {
  title: "Finito - Fine Dining Restaurant | Culinary Excellence",
  description: "Experience exceptional fine dining at Finito. Award-winning cuisine with locally-sourced ingredients. Reserve your table for an unforgettable dining journey.",
  keywords: "fine dining, restaurant, cuisine, reservations, gourmet food, culinary excellence",
  metadataBase: new URL("https://finito-restaurant.com"),
  alternates: {
    canonical: "https://finito-restaurant.com"
  },
  openGraph: {
    title: "Finito - Fine Dining Restaurant",
    description: "Experience exceptional fine dining with locally-sourced ingredients and international flavors",
    url: "https://finito-restaurant.com",
    siteName: "Finito Restaurant",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765876155963-cssk7kfo.jpg",
        alt: "Finito Fine Dining Restaurant"
      }
    ]
  },
  twitter: {
    ...
    title: "Finito - Fine Dining Restaurant",
    description: "Experience exceptional fine dining with locally-sourced ingredients",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35vmIsFKiMtTSUSBP7nWGRgR0We/uploaded-1765876155963-cssk7kfo.jpg"]
  },
  robots: {
    index: true,
    follow: true
